...
class BaseVideo extends _1.Base {
    ...
    load(data) {
        ...
        this.likeCount = common_1.stripToInt((_a = topLevelButtons[0].toggleButtonRenderer.defaultText.accessibility) === null || _a === void 0 ? void 0 : _a.accessibilityData.label);
        this.dislikeCount = common_1.stripToInt((_b = topLevelButtons[1].toggleButtonRenderer.defaultText.accessibility) === null || _b === void 0 ? void 0 : _b.accessibilityData.label);
        ...
        const secondaryContents = data[3].response.contents.twoColumnWatchNextResults.secondaryResults.secondaryResults
            .results;
        const upNext = ((_f = secondaryContents.find((s) => "compactAutoplayRenderer" in s)) === null || _f === void 0 ? void 0 : _f.compactAutoplayRenderer.contents[0]) || null;
